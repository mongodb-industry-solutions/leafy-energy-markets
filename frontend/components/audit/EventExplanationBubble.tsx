...
import { EVENT_EXPLANATIONS } from '@/lib/event-explanations';

interface EventExplanationBubbleProps {
  scenarioId: string;
  version: number;
}
...
export default function EventExplanationBubble({ scenarioId, version }: EventExplanationBubbleProps) {
  const { darkMode } = useDarkMode();

  const explanations = EVENT_EXPLANATIONS[scenarioId];
